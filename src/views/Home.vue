    ...
    <section>
      <div class="circle"></div>
        ...
        <ul class="thumb">
          ...
          <li><div @click="imgSlider(false, true, false, '#eb7495')" style="background-color: #eb7495;">2</div></li>
          <li><div @click="imgSlider(false, false, true, '#d752b1')" style="background-color: #d752b1;">3</div></li>
        </ul>
        <ul class="sci">
